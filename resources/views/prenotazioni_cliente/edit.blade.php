...
<a href="/prenotazioni_cliente/{{$prenotazione->id}}" class="btn btn-outline-secondary" style="margin-left: 10px">Annulla</a>
<br>
<br>
{!! Form::open(['action' => ['PrenotazioneClienteController@store', $prenotazione->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
<div class="col-12">
    <!-- Custom Tabs -->
    <div class="card">
        <div class="card-header d-flex p-0">
            <h3 class="card-title p-3">Modifica dati prenotazione</h3>
        </div><!-- /.card-header -->
        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{{Form::select('camera_numero', $camere, $prenotazione->camera->numero, [ 'class' => 'form-control', 'placeholder' => 'Seleziona una camera' ])}}}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
